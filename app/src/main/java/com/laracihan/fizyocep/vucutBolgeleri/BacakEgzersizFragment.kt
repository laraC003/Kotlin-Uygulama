...
class BacakEgzersizFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val videoMappings = listOf(
            Triple(R.id.btnVideo1, R.raw.bacak_egzersizi, Pair(R.id.checkbox1, R.id.statusText1)),
            Triple(R.id.btnVideo2, R.raw.bacak_egzersizi2, Pair(R.id.checkbox2, R.id.statusText2)),
            Triple(R.id.btnVideo3, R.raw.bacak_egzersizi3, Pair(R.id.checkbox3, R.id.statusText3)),
            Triple(R.id.btnVideo4, R.raw.bacak_egzersizi4, Pair(R.id.checkbox4, R.id.statusText4)),
            Triple(R.id.btnVideo5, R.raw.bacak_egzersizi5, Pair(R.id.checkbox5, R.id.statusText5)),
            Triple(R.id.btnVideo6, R.raw.bacak_egzersizi6, Pair(R.id.checkbox6, R.id.statusText6)),
            Triple(R.id.btnVideo7, R.raw.bacak_egzersizi7, Pair(R.id.checkbox7, R.id.statusText7)),
            Triple(R.id.btnVideo8, R.raw.bacak_egzersizi8, Pair(R.id.checkbox8, R.id.statusText8)),
            Triple(R.id.btnVideo9, R.raw.bacak_egzersizi9, Pair(R.id.checkbox9, R.id.statusText9)),
