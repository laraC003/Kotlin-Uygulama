...
class BoyunEgzersizFragment : Fragment() {
    ...
    ): View = inflater.inflate(R.layout.fragment_boyun_egzersiz, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val videoMappings: List<Triple<Int, Pair<Int, Int>, Triple<Int, Int, Int>>> = listOf(
            Triple(R.id.btnVideo1, Pair(R.raw.boyun_egzersizi, 20_000), Triple(R.id.checkbox1, R.id.statusText1, 1)),
            Triple(R.id.btnVideo2, Pair(R.raw.boyun_egzersizi2, 20_000), Triple(R.id.checkbox2, R.id.statusText2, 2)),
            Triple(R.id.btnVideo3, Pair(R.raw.boyun_egzersizi3, 30_000), Triple(R.id.checkbox3, R.id.statusText3, 3)),
            Triple(R.id.btnVideo4, Pair(R.raw.boyun_egzersizi4, 30_000), Triple(R.id.checkbox4, R.id.statusText4, 4)),
            Triple(R.id.btnVideo5, Pair(R.raw.boyun_egzersizi5, 20_000), Triple(R.id.checkbox5, R.id.statusText5, 5)),
            Triple(R.id.btnVideo6, Pair(R.raw.boyun_egzersizi6, 20_000), Triple(R.id.checkbox6, R.id.statusText6, 6))
        )
        ...
        for ((buttonId, videoData, viewData) in videoMappings) {
            ...
            val sharedPrefsKey = "${userId}_boyun_done_$index"
            val firestoreKey = "boyun_egzersizi_$index"
