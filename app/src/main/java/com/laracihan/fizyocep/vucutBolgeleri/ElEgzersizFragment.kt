...
class ElEgzersizFragment : Fragment() {
    ...
    private val args: ElEgzersizFragmentArgs by navArgs()

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View = inflater.inflate(R.layout.fragment_el_egzersiz, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val videoMappings = listOf(
            Triple(R.id.btnVideo1, Pair(R.raw.el_egzersizi1, 20000), Triple(R.id.checkbox1, R.id.statusText1, 1)),
            Triple(R.id.btnVideo2, Pair(R.raw.el_egzersizi2, 20000), Triple(R.id.checkbox2, R.id.statusText2, 2))
        )
        ...
        for ((buttonId, videoData, viewData) in videoMappings) {
            ...
            val sharedPrefsKey = "${userId}_el_done_$index"
            val firestoreKey = "el_egzersizi_$index"
